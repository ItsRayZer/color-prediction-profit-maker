/**
 * ===========================================================================
 * WinGo 30-Second System (Modular Timeframe Engine)
 * ===========================================================================
 */
(function(global) {
  'use strict';

  const WinGo30sSystem = {
    id: '30s',
    label: 'WinGo 30s',
    duration: 30, // seconds
    periodCode: '10005',
    totalPeriodsPerDay: 2880,
    apiEndpoint: 'https://draw.ar-lottery01.com/WinGo/WinGo_30S/GetHistoryIssuePage.json',
    proxyPath: '/api-wingo/WinGo/WinGo_30S/GetHistoryIssuePage.json',
    ...
    /**
     * Validate if an issue/period string belongs to 30s
     */
  ...
  if (typeof module !== 'undefined' && module.exports) {
    module.exports = WinGo30sSystem;
  } else {
    global.WinGo30sSystem = WinGo30sSystem;
    if (!global.WIN_GO_SYSTEMS) global.WIN_GO_SYSTEMS = {};
    global.WIN_GO_SYSTEMS['30s'] = WinGo30sSystem;
  }
